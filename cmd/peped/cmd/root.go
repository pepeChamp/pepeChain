...
import (
	...
	pepekr "github.com/pepeChamp/pepeChain/crypto/keyring"

	pepeClient "github.com/pepeChamp/pepeChain/client"
)
...
// NewRootCmd creates a new root command for peped. It is called once in the
// main function.
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	initClientCtx := client.Context{}.
		...
		WithKeyringOptions(pepekr.Option()).
		WithViper(EnvPrefix)
	...
	rootCmd.AddCommand(
		...
		queryCommand(),
		txCommand(),
		pepeClient.KeyCommands(app.DefaultNodeHome),
	)
...
func (a appCreator) appExport(
	...
	if height != -1 {
		pepeApp = app.New(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)

		if err := pepeApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		pepeApp = app.New(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)
	}

	return pepeApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs)
}
